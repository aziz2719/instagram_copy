...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('publications', '0002_auto_20210310_2040'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_comments', to='publications.publications')),
            ],
        ),
    ]
